...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4FOCALSTEPPINGACTION_H
#define G4DETECTORS_PHG4FOCALSTEPPINGACTION_H
...
class PHG4FoCalSteppingAction : public PHG4SteppingAction
{
 public:
  //! constructor
  PHG4FoCalSteppingAction(PHG4FoCalDetector*, const int absorberactive);

  //! destructor
  virtual ~PHG4FoCalSteppingAction();
...
#endif  // G4DETECTORS_PHG4FOCALSTEPPINGACTION_H
